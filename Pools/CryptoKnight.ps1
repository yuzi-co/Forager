...
if ($Querymode -eq "Core") {
    $Pools = @(
        ...
        [PSCustomObject]@{ Coin = "BitTube"    ; Symbol = "TUBE" ; Algo = "CnSaber"  ; Port = 5631  ; WalletSymbol = "ipbc"      ; Server = "tube.ingest.cryptoknight.cc" }
        ...
        [PSCustomObject]@{ Coin = "Swap"       ; Symbol = "XWP"  ; Algo = "CnSwap"   ; Port = 7731  ; WalletSymbol = "swap"      }
